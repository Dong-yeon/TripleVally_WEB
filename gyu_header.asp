                ...
                <div id="gnb_box" style="width:1100px;margin:0 auto">
                    ...
                    <div class="logo">
                        <table cellspacing='0' cellpadding='0' border='0'>
                            <tr>
                                <td><a href='/gyu/main.asp' target='_self'><img src='/RAD/PEG/gyu_logo.png' width='300px' height='50px' border='0'></a></td>
                            </tr>
                        </table>
                    </div><!-- logo End -->
                        ...
                        <div id="css_gnb_frame">
                            <div class="mm_wrap">
                                <ul class="mm">
                                    ...
                                    <li pid="81" off="교육서비스" on="교육서비스" class="" hover="" onClick="location.href='/lecture/default.asp?usertype=univ';">나만의 진로설계 프로그램</li>                                    
                                    <li pid="5" off="커뮤니티" on="커뮤니티" class="" hover="" onMouseOver="css_menu.over(this)" onClick="location.href='/notice/list.asp';">커뮤니티</li>
									<li pid="6" off="로그아웃" on="로그아웃" class="" hover="" onClick="location.href='/member/gyu_logout.asp';">로그아웃</li>
                                </ul>
                            </div>
                            <div class="sm_box">
                            ...
                            <div class="sm_box">
                                <ul class="sm s5" style="display:none">
                                    ...
                                    <li class="" hover="" onClick="location.href='/member/gyu_login.asp';">로그인</li>
									<%ElseIf Request.cookies("ezone")("GYU") = "Y" Then%>
									<li class="" hover="" onClick="location.href='/member/gyu_logout.asp';">로그아웃</li>
